...
package com.almalence.plugins.capture.ocr;
...
public class OCRCapturePlugin extends PluginCapture
{
	private static final String	TAG						= "OCRCapturePlugin";
	...
	private int					IMAGES_AMOUNT				= 9;
	private int[]				pauseBetweenShots		= { 0, 0, 250, 250, 500, 750, 1000, 1250, 1250 };
	private int[]				pauseBetweenShotsCamera2= { 0, 0, 250, 250, 500, 750, 1000, 1250, 1250 };//{ 100, 200, 250, 250, 500, 750, 1000, 1250 };

	public OCRCapturePlugin()
	{
		super("com.almalence.plugins.ocr", 0, 0, 0, null);
	}
